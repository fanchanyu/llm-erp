...
from app.api import chat, inventory, purchase, bom, dispatch, events, accounting, quality, dashboard, reports, conversations, customers, sales_orders, crm_events, factory, leads, opportunities, contracts, decisions, organization, production, warehouse, compliance, security_mgmt, mps, mrp, war_room
...
app.include_router(mrp.router, prefix="/api", tags=["mrp"])
app.include_router(war_room.router, prefix="/api", tags=["war-room"])
